...
{{--    {{$ab->name}}--}}
    <table class="table">
        ...
        <tr>
            ...
            <td>
                ...
                <div class="collapse" id="collapseAdd-{{$ab->id}}">
                    <div class="card card-body">
                        <form action="{{ route('abonent.update', $ab->id) }}" method="post" enctype="multipart/form-data">
                            @method('PUt')
                            @csrf
            ...
            <td>
                <form action="{{route('abonent.destroy', $ab->id)}}" method="post" enctype="multipart/form-data">
                    @method('Delete')
                    @csrf
...
<div class="collapse" id="collapseAdd">
    <div class="card card-body">
        <form action="{{ route('abonent.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <input type="text"  name="name" placeholder="Введите стационарный номер">
            <input type="submit" value="ok">
        </form>
